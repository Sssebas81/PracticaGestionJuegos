...
export class RolePermission {
    ...
    @ManyToOne(() => Role, (role) => role.rolePermissions, { onDelete: 'CASCADE', nullable: false, eager: true }) // Many-to-one relationship with Role entity, with cascade delete, meaning that if a role is deleted, all associated role-permission relationships will also be deleted
    ...
    @ManyToOne(() => Permission, (permission) => permission.rolePermissions, { onDelete: 'CASCADE', nullable: false, eager: true }, )
